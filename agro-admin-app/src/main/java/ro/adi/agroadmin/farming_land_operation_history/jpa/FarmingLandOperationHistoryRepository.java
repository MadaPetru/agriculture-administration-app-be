...
public interface FarmingLandOperationHistoryRepository extends JpaSpecificationExecutor<FarmingLandOperationHistoryEntity>, JpaRepository<FarmingLandOperationHistoryEntity, Integer> {
    ...
    List<ProfitabilityPerYearView> revenueAndCostsPerYearForFarmingLand(Integer createdBy, Integer startYear, Integer endYear, Integer farmingLandId);
    ...
    List<ProfitabilityPerOperationView> getProfitabilityPerOperationsForFarmingLand(Integer createdBy, Integer startYear, Integer endYear, Integer farmingLandId);
    ...
    boolean existsByYearAndCreatedBy(Integer year, Integer createdBy);
    ...
    boolean existsByYearAndCreatedByAndOperation(Integer year, Integer createdBy, OperationType operation);
    ...
    int countByYearAndCreatedByAndOperation(Integer year, Integer createdBy, OperationType operation);
}
