...
@Service
public class UpdateFarmingLandStatisticsPerYearAndOperationWhenOperationIsUpdatedService extends UpdateFarmingLandStatisticsPerYearAndOperationService {

    protected UpdateFarmingLandStatisticsPerYearAndOperationWhenOperationIsUpdatedService(FarmingLandStatisticsPerYearAndOperationMapper mapper, FarmingLandsStatisticsPerOperationAndYearRepository repository) {
    ...
    public boolean isType(UpdateFarmingLandStatisticsPerYearAndOperationScenario scenario) {
        return scenario.equals(UpdateFarmingLandStatisticsPerYearAndOperationScenario.UPDATE_FIELD_OPERATION);
    }
}
